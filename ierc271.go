...
// Deprecated: Use IERC1271MetaData.Sigs instead.
// IERC1271FuncSigs maps the 4-byte function signature to its string representation.
var IERC1271FuncSigs = IERC1271MetaData.Sigs
